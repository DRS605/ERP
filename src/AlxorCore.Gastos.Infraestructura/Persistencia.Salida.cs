...
/// <summary>Mapeo EF Core de la bandeja de salida (outbox) del módulo Gastos.</summary>
...
internal sealed class RepositorioSalidaGastos : IRepositorioSalidaGastos
{
    private readonly GastosDbContext _contexto;

    public RepositorioSalidaGastos(GastosDbContext contexto) => _contexto = contexto;
