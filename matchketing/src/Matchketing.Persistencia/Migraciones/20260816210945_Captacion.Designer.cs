...
namespace Matchketing.Persistencia.Migraciones
{
    ...
    [Migration("20260816210945_Captacion")]
    partial class Captacion
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Matchketing.Captacion.Dominio.EnvioFormulario", b =>
                {
                    ...
                    b.HasIndex("EmpresaId", "FormularioId", "RecibidoEn")
                        .HasDatabaseName("ix_envio_empresa_formulario_fecha");
            ...
            modelBuilder.Entity("Matchketing.Captacion.Dominio.Formulario", b =>
                {
                    ...
                    b.Property<string>("PaginaGracias")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
                        .HasColumnName("pagina_gracias");

                    b.Property<bool>("PideEmpresa")
                        .HasColumnType("boolean")
                        .HasColumnName("pide_empresa");

                    b.Property<bool>("PideMensaje")
                        .HasColumnType("boolean")
                        .HasColumnName("pide_mensaje");

                    b.Property<bool>("PideTelefono")
                        .HasColumnType("boolean")
                        .HasColumnName("pide_telefono");
                    ...
                    b.HasIndex("Clave")
                        .IsUnique()
                        .HasDatabaseName("ix_formulario_clave");
            ...
            modelBuilder.Entity("Matchketing.Cumplimiento.Dominio.Consentimiento", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("OtorgadoEn")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("otorgado_en");

                    b.Property<DateTimeOffset?>("RetiradoEn")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("retirado_en");

                    b.Property<string>("TextoAceptado")
                        .HasMaxLength(1000)
                        .HasColumnType("character varying(1000)")
                        .HasColumnName("texto_aceptado");

                    b.HasKey("Id");

                    b.HasIndex("EmpresaId", "ContactoId", "Finalidad")
                        .HasDatabaseName("ix_consentimiento_empresa_contacto");
            ...
            modelBuilder.Entity("Matchketing.Match.Dominio.PuntuacionMatch", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CalculadaEn")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("calculada_en");
                    ...
                    b.Property<int>("Encaje")
                        .HasColumnType("integer")
                        .HasColumnName("encaje");
                    ...
                    b.Property<bool>("SinHistorico")
                        .HasColumnType("boolean")
                        .HasColumnName("sin_historico");

                    b.HasKey("Id");

                    b.HasIndex("EmpresaId", "ContactoId")
                        .IsUnique()
                        .HasDatabaseName("ix_puntuacion_empresa_contacto");
            ...
            modelBuilder.Entity("Matchketing.Match.Dominio.Senal", b =>
                {
                    ...
                    b.HasIndex("EmpresaId", "ContactoId", "OcurridaEn")
                        .HasDatabaseName("ix_senal_empresa_contacto_fecha");
